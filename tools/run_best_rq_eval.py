...
def run_eval(
    ...
    env = os.environ.copy()
    env["BEST_RQ_CONFIG"] = str(config_path)
    env["BEST_RQ_CHECKPOINT"] = str(checkpoint_path)
...
if __name__ == "__main__":
    parser = argparse.ArgumentParser(description="Run Best-RQ evaluation from a checkpoint folder.")
